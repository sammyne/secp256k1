...
func TestGenerateSharedSecret(t *testing.T) {
	privKey1, err := secp256k1.NewPrivateKey(secp256k1.S256())
	if err != nil {
		t.Errorf("private key generation error: %s", err)
		return
	}
	privKey2, err := secp256k1.NewPrivateKey(secp256k1.S256())
	if err != nil {
		t.Errorf("private key generation error: %s", err)
		return
	}

	secret1 := secp256k1.GenerateSharedSecret(privKey1, privKey2.PubKey())
	secret2 := secp256k1.GenerateSharedSecret(privKey2, privKey1.PubKey())
...
func TestCipheringBasic(t *testing.T) {
	privkey, err := secp256k1.NewPrivateKey(secp256k1.S256())
	if err != nil {
	...
	out, err := secp256k1.Encrypt(privkey.PubKey(), in)
	if err != nil {
